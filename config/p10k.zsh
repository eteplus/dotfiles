# Generated by Powerlevel10k configuration wizard on 2025-06-16 at 13:24 CST.
...
# 2 lines, disconnected, full frame, lightest-ornaments, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      # If tag name is at most 64 characters long, show it in full.
      # Otherwise show the first 12 … the last 12.
